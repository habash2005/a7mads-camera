...
const firebaseConfig = {
  ...
  authDomain: import.meta.env.VITE_FIREBASE_AUTH_DOMAIN || `${PROJECT_ID}.firebaseapp.com`, // ✅ correct
  projectId: import.meta.env.VITE_FIREBASE_PROJECT_ID || PROJECT_ID,
  storageBucket: import.meta.env.VITE_FIREBASE_STORAGE_BUCKET || `${PROJECT_ID}.firebaseapp.com`, // ✅ bucket identifier
...
export const storage = getStorage(app); // uses the appspot.com bucket above
